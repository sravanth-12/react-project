      ...
      <div className="employee-report">
        ...
        <form>
          <div className="form-group">
            ...
            <input type="text" id="employee-name" placeholder="Type for hints..." required />
          </div>
          <div className="form-group">
            <label htmlFor="project-name">Project Name</label>
            <input type="text" id="project-name" placeholder="Type for hints..." />
          </div>
          <div className="form-group">
          ...
          <div className="form-group">
            <label htmlFor="approved-timesheets">Only Include Approved Timesheets</label>
            <input type="checkbox" id="approved-timesheets" />
          </div>
